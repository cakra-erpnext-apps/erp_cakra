...
export default defineConfig(async ({ mode }) => {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          icons: [
            {
              src: '/assets/crm_cakra/manifest/manifest-icon-192.maskable.png',
              sizes: '192x192',
              type: 'image/png',
              purpose: 'any',
            },
            ...
            {
              src: '/assets/crm_cakra/manifest/manifest-icon-512.maskable.png',
              sizes: '512x512',
              type: 'image/png',
              purpose: 'any',
            },
  ...
  config.plugins.unshift(
    frappeui({
      ...
      jinjaBootData: true,
      buildConfig: {
        indexHtmlPath: '../crm_cakra/www/crm.html',
        emptyOutDir: true,
        sourcemap: true,
      },
    }),
