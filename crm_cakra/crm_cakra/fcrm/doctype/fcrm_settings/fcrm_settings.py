...
from crm_cakra.demo.api import create_demo_data
from crm_cakra.install import after_install
...
class FCRMSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from crm_cakra.fcrm.doctype.crm_dropdown_item.crm_dropdown_item import CRMDropdownItem
