...
from crm_cakra.api.exchange_rate import (
...
class TestFetchFromFrankfurter(FrappeTestCase):
	@patch("crm_cakra.api.exchange_rate.requests.get")
	...
	@patch(
		"crm_cakra.api.exchange_rate.requests.get",
...
class TestGetExchangeRate(FrappeTestCase):
	...
	@patch("crm_cakra.api.exchange_rate._fetch_exchange_rate")
