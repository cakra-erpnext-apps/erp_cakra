...
class TestDemoData(FrappeTestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		from crm_cakra.demo.api import clear_demo_data
	...
	def test_demo_data_lifecycle(self):
		from crm_cakra.demo.api import clear_demo_data, create_demo_data
		from crm_cakra.demo.users import DEMO_USERS
