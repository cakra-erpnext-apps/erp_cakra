// Purchase Receipt list: CMI Validate/Invalidate and Void/Unvoid actions.
(function () {
	...
	if (!frappe.views.ListView.prototype._cmi_pr_actions_patched) {
	...
	settings.onload = function (listview) {
		...
		window.cmi_workflow_list_actions(listview, "Purchase Receipt", __("Purchase Receipt"));
	};
	settings.refresh = function (listview) {
		if (typeof previous_refresh === "function") previous_refresh(listview);
		window.cmi_workflow_list_actions(listview, "Purchase Receipt", __("Purchase Receipt"));
	};
	frappe.listview_settings["Purchase Receipt"] = settings;
})();
