...
def _bl_payment_status(doc):
	...
	maupun Expense Note (uang keluar). Cakupan dokumen sengaja disamakan dengan summary_data
	di file ini (draft ikut, cancelled/void dibuang):
	  ...
	  Expense Note -> tidak void. Lunas = flag `paid` (di-set update_expense_note_paid_status
	                  ...
	                  seperti label status EN di summary_data, `paid` menang sendiri — dan di
